...
export const translate = async (nlQuery: string): Promise<String> => {
    const baseUrl = process.env.REACT_APP_API_BASE_URL || '';
    const queryTranslatorUrl = `${baseUrl}/query-translator`;
    const translateUrl = `${queryTranslatorUrl}/translate`;
